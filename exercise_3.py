...
if __name__ == "__main__":
    ...
    # First graph of Exercise 3 -> Plots transmission coefficients for several k_0
    ...
    for t in np.arange(0, t_final, dt):
        ...
        if t == 500 * dt or t == 1500 * dt or t == 3000 * dt or t == 5000*dt or t == 9000 * dt:
    ...
    # Similar to exercise 1 but adding more timestamps.
    # Note that the function used is the same but adding the timestamps and broader x-axis.
    results.psi_squared_2_plot_ex3(psi_squared_data, x_values, potential)
